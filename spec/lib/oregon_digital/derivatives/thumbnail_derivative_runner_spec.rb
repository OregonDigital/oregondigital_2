...
RSpec.describe OregonDigital::Derivatives::ThumbnailDerivativeRunner do
  verify_contract :thumbnail_derivative_runner
  subject { OregonDigital::Derivatives::ThumbnailDerivativeRunner.new(file, path, callback) }
